import os
import re
import glob #glob is a built-in Python module for finding files by pattern matching (wildcards), like how you'd search files in a terminal.
...
load_dotenv()  # loads Grqo_API_KEY from .env
