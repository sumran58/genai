...
class UserInput(BaseModel):
    age:Annotated[int,Field(...,lt=120,gt=0,description='age of the user')]
    weight:Annotated[float,Field(...,gt=0,description='weight of the user')]
    height:Annotated[float,Field(...,lt=2.5,gt=0,description='height of the user')]
    ...
    city:Annotated[str,Field(...,description='city of the user belongs to ')]
